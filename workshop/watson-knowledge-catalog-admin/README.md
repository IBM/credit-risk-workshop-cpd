...
![add connection to catalog](../.gitbook/assets/images/wkc-admin/wkc-add-conn-db2wh.png)

* Enter the connection details and click `Create`:

![enter db2 warehouse connection details](../.gitbook/assets/images/wkc-admin/wkc-add-conn-db2wh-details.png)
